...
public class Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put(List.get(0), R.drawable.i16);
        map.put(List.get(1), R.drawable.i2);
        map.put(List.get(2), R.drawable.i29);
        map.put(List.get(3), R.drawable.i3);
        map.put(List.get(4), R.drawable.i42);
        map.put(List.get(5), R.drawable.i45);
        map.put(List.get(6), R.drawable.i5);
        map.put(List.get(7), R.drawable.i6);
        map.put(List.get(8), R.drawable.i7);
        map.put(List.get(9), R.drawable.i74);
        map.put(List.get(10), R.drawable.i8);
        map.put(List.get(11), R.drawable.i97);
